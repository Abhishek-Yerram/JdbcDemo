...
public class JoinsDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            rs=stmt.executeQuery("SELECT c.id,c.first_name,s.name FROM candidates c INNER JOIN candidate_skills cs ON c.id=cs.candidate_id INNER JOIN skills s ON s.id=cs.skill_id WHERE c.id=cs.candidate_id");
